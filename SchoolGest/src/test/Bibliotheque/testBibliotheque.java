...
//            List<Bibliothecaire> list = ser.search("bbbbbb");
...
//        Bibliotheque l4 = new Bibliotheque(1);
...
////        Bibliotheque bibb = new Bibliotheque(2);
////        System.out.println(ser.nbreLivre(bibb));
////        
...
//        Livre l5 = new Livre(11, 2, "koo", "bbb2", "ccc2", "ddd2", "1852-01-01", 504,55445);
//        Livre l6 = new Livre(2, "k", "", "", "", "", 0,55445);
////        if(l5.equals(l2)) System.out.println("hihihihihih");
//        try{
//            System.out.println(ser.triAll("dateSortie", "desc"));
////            ser.ajouter(l5);
////            ser.ajouter(l1);
////            ser.update(l5);
////            ser.delete(l3);
...
////            System.out.println(list);
////            ser.search(l5);
////            System.out.println(ser.search("60"));
////            System.out.println(ser.search(l3));
//        } catch(SQLException ex){
//            System.out.println(ex);
//        }
    }
